...
for i = 1: 9
    ...
    [cos_theta, theta, a1, b1, a2, b2] = right_bottom_corner_angle_calculator(ROI_msk, 0.3, 1);
    ...
    export_fig(strcat("F:\滑铁卢大学\proj\lqy\left bottom angle results fit line method\", num2str(i), " angle is ", num2str(theta)));
