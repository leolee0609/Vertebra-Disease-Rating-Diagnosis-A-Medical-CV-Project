function [cos_theta, theta] = left_top_angle_fit_line_function(ROI_msk, ifshow)
    % this function calculates the left-top angle

    % mirror-reverse the mask
    ROI_msk = mirror_reverse(ROI_msk);



    [cos_theta, theta, a1, b1, a2, b2] = right_top_corner_angle_calculator(ROI_msk, 0.3, ifshow);
