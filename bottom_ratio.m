function ratio = bottom_ratio(ROI_msk)
    ...
    % get the left-bottom corner point
    ...
    % calculate the point-to-line distance between the left-bottom point to
    ...
    if a > 1000
        ...
        lsl = abs(a * lbp(1) - lbp(2) + b) / sqrt(a^2 + 1);
    end
