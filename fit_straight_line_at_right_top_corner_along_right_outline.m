function [a3, b3, training_set] = fit_straight_line_at_right_top_corner_along_right_outline(ROI_msk, perc, ifshow)
    % this function returns the coefficients of the tangent line at the
    % right-top point along the right outline, which is obtained using
    % linear regression. We first get
    % the closest perc% points to the right-top point on the right
    ...
    [a3, b3] = novel_linear_regression_trainer_for_right_outline(feature, label);
