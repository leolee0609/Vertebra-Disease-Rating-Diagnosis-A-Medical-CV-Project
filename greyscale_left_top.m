...
for i = 25: 52
    ...
    [mean_greyscale, mean_greyscale_whole, ratio, std_diff] = left_top_mean_greyscale_calculator(img, ROI_msk, 0.3, 1);
    ...
    export_fig(strcat("F:\滑铁卢大学\proj\lqy\greyscale results left top\", num2str(i), " SMD is ", num2str(std_diff)));
